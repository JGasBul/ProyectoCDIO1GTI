...
const char WiFiSSID[] = "sinDefinir";
const char WiFiPSK[] = "sinDefinir";
#else // Conexion fuera de la UPV
const char WiFiSSID[] = "NANA";
const char WiFiPSK[] = "briNa95@";
#endif
...
#else
const char Server_Host[] = "sinDefinir";
const int Server_HttpPort = 80;
#endif
...
#else
const char Rest_Host[] = "sinDefinir";
String MyWriteAPIKey = "sinDefinir"; // Escribe la clave de tu canal Dweet
#endif
